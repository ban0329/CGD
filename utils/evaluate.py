...
def compute_map_and_print(dataset, featuretype, ranks, gnd, kappas=[1, 5, 10], verbose=False):
    ...
    # new evaluation protocol
        ...
        print('>> mAP Medium: {}, Hard: {}'.format(np.around(mapM * 100, decimals=2), np.around(mapH * 100, decimals=2)))
